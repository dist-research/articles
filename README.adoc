...
* Tendermint : https://tendermint.com/docs/introduction/introduction.html#tendermint-vs-x
* Tendermint consensus algorithm : https://arxiv.org/abs/1807.04938 (updated version can be eventually found on https://github.com/tendermint/spec/releases) 
