...
* M. Castro, B Liskov: Practical Byzantine Fault Tolerance : http://pmg.csail.mit.edu/papers/osdi99.pdf
...
https://softwareengineeringdaily.com/2018/03/26/consensus-systems-with-ethan-buchman , https://github.com/ebuchman/thesis/blob/master/Buchman_Ethan_201606_MAsc.pdf ::
  Podcast Software Engineering Daily - Consensus Systems and Tendermint with Ethan Buchman, plus his thesis on Tendermint

== Papers in consideration to be read

* Mike Burrows, Google: The Chubby lock service for loosely-coupled distributed systems : http://static.googleusercontent.com/media/research.google.com/en//archive/chubby-osdi06.pdf
* L. Baird: THE SWIRLDS HASHGRAPH CONSENSUS ALGORITHM : https://swirlds.com/downloads/SWIRLDS-TR-2016-01.pdf
...
* Tendermit : https://tendermint.com/docs/introduction/introduction.html#tendermint-vs-x
* Jepsen report on Tendermint : https://jepsen.io/analyses/tendermint-0-10-2
