...
https://medium.com/tendermint/a-to-z-of-blockchain-consensus-81e2406af5a3::
  Article on what is the consensus protocol in blockchain systems. Explaining the PoW and PoS is only defence mechanism for Sybil attack.
...
* Team Rocket: Snowflake to Avalanche: https://ipfs.io/ipfs/QmUy4jh5mGNZvLkjies1RWM4YuvJh5o2FYopNPVYwrRVGV
