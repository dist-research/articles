...
* https://arxiv.org/abs/1805.04263 : [paper] OpSets: Sequential Specifications for Replicated Datatypes (Martin Kleppmann, Victor B. F. Gomes, Dominic P. Mulligan, Alastair R. Beresford)
